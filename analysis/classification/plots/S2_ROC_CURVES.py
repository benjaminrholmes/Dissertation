...
from analysis.classification.models.S2.MLP.cS2_FT4_hyper_NN import nn_y_per_test, nn_y_pred_per, nn_mod_per, nn_X_per_test
from analysis.classification.models.S2.MLP.cS2_FT4_hypo_NN import nn_y_po_test, nn_y_pred_po, nn_mod_po, nn_X_po_test
from analysis.classification.models.S2.SVM.cS2_FT4_hyper_SVM import svm_y_per_test, svm_y_pred_per, svm_mod_per, svm_X_per_test
from analysis.classification.models.S2.SVM.cS2_FT4_hypo_SVM import svm_y_po_test, svm_y_pred_po, svm_mod_po, svm_X_po_test
from analysis.classification.models.S2.XGBoost.S2_FT4_hyper import xgb_y_per_test, xgb_y_pred_per, xgb_mod_per, xgb_X_per_test
from analysis.classification.models.S2.XGBoost.S2_FT4_hypo import xgb_y_po_test, xgb_y_pred_po, xgb_mod_po, xgb_X_po_test

print(colored("\n...........SHIP2 CLASSIFICATION PLOTTING STARTED............", "green"))
...
plt.title('SHIP-2 ROC curve')
plt.legend(loc="lower right")
plt.savefig('D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S2\\S2_ROC.png')
plt.show()
...
plt.savefig('D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S2\\S2_CM.png')
plt.show()
...
plt.title("SHIP-2 hypothyroidism feature importance")
plt.subplots_adjust(left=0.2)
plt.savefig('D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S2\\S2_FI_hypo.png')
plt.show()
...
plt.title("SHIP-2 hyperthyroidism feature importance")
plt.subplots_adjust(left=0.2)
plt.savefig('D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S2\\S2_FI_hyper.png')
plt.show()
...
importance_df_po.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S2\\S2_imp_hypo.csv")
importance_df_per.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S2\\S2_imp_hyper.csv")

print(colored("\n...........SHIP2 CLASSIFICATION PLOTTING FINISHED............", "green"))
