...
from pre_processing.pre_processing import hyper_TREND0_scaled
from termcolor import colored

print(colored("\n...........TREND0 HYPERTHYROIDISM CLASSIFICATION SVM MODELLING STARTED............\n\n", "green"))

X, y = hyper_TREND0_scaled.drop(['FT4', 'BIN_HYPO', 'BIN_HYPER'], axis=1), hyper_TREND0_scaled[['BIN_HYPER']]
...
results_df.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\T0\\T0_SVM_hyper.csv")
...
print(colored("\n...........TREND0 HYPERTHYROIDISM CLASSIFICATION SVM MODELLING FINISHED............\n\n", "green"))
