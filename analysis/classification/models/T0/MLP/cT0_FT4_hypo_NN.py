...
print(colored("\n...........TREND0 HYPOTHYROIDISM CLASSIFICATION MLP MODELLING STARTED............\n\n", "green"))
...
mod_best = MLPClassifier(max_iter=1500, random_state=123).fit(X_train, y_train.values.ravel())
...
results_df.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\T0\\T0_MLP_hypo.csv")
...
print(colored("\n...........TREND0 HYPOTHYROIDISM CLASSIFICATION MLP MODELLING FINISHED............\n\n", "green"))
