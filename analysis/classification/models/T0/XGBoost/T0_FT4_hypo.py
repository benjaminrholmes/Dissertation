...
from pre_processing.pre_processing import hypo_TREND0_scaled
from termcolor import colored

print(colored("\n...........TREND0 HYPOTHYROIDISM CLASSIFICATION XGBOOST MODELLING STARTED............\n\n", "green"))

X, y = hypo_TREND0_scaled.drop(['FT4', 'BIN_HYPO', 'BIN_HYPER'], axis=1), hypo_TREND0_scaled[['BIN_HYPO']]
...
results_df.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\T0\\T0_XGB_hypo.csv")
...
print(colored("\n...........TREND0 HYPOTHYROIDISM CLASSIFICATION XGBOOST MODELLING FINISHED............\n\n", "green"))
