...
from pre_processing.pre_processing import hyper_SHIP3_scaled
from termcolor import colored

print(colored("\n...........SHIP3 HYPERTHYROIDISM CLASSIFICATION SVM MODELLING STARTED............\n\n", "green"))

X, y = hyper_SHIP3_scaled.drop(['FT4', 'BIN_HYPO', 'BIN_HYPER'], axis=1), hyper_SHIP3_scaled[['BIN_HYPER']]
...
mod_best = svm.SVC(kernel="rbf", gamma=1e-4, C=1.5, probability=True)
...
results_df.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S3\\S3_SVM_hyper.csv")

svm_y_pred_per = mod_best.predict_proba(X_test)
svm_mod_per = mod_best
svm_y_per_test = y_test
svm_X_per_test = X_test

print(colored("\n...........SHIP3 HYPERTHYROIDISM CLASSIFICATION SVM MODELLING FINISHED............\n\n", "green"))