...
from pre_processing.pre_processing import hypo_SHIP1_scaled
from termcolor import colored

print(colored("\n...........SHIP1 HYPOTHYROIDISM CLASSIFICATION XGBOOST MODELLING STARTED............\n\n", "green"))

X, y = hypo_SHIP1_scaled.drop(['FT4', 'BIN_HYPO', 'BIN_HYPER'], axis=1), hypo_SHIP1_scaled[['BIN_HYPO']]
...
results_df.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S1\\S1_XGB_hypo.csv")
...
print(colored("\n...........SHIP1 HYPOTHYROIDISM CLASSIFICATION XGBOOST MODELLING FINISHED............\n\n", "green"))
