...
from sklearn.metrics import roc_auc_score, f1_score, confusion_matrix, accuracy_score, precision_score, recall_score, log_loss, matthews_corrcoef
from sklearn.model_selection import train_test_split, GridSearchCV, StratifiedKFold
from imblearn.over_sampling import SMOTE
from pre_processing.pre_processing import hypo_SHIP0_scaled
from termcolor import colored

print(colored("\n...........SHIP0 HYPOTHYROIDISM CLASSIFICATION XGBOOST MODELLING STARTED............\n\n", "green"))

X, y = hypo_SHIP0_scaled.drop(['FT4', 'BIN_HYPO', 'BIN_HYPER'], axis=1), hypo_SHIP0_scaled[['BIN_HYPO']]
...
grid_mse.fit(X_train_sm, y_train_sm)
...
mod_best.fit(X_train_sm, y_train_sm)
...
matt_coef_train = matthews_corrcoef(y_train_sm, xgb_train_preds)
...
matt_coef_test = matthews_corrcoef(y_test, xgb_test_preds)
...
results = {'Train': [accuracy_train, precision_train, recall_train, f1_score_train, auc_train, log_loss_train, matt_coef_train],
           'Test': [accuracy_test, precision_test, recall_test, f1_score_test, auc_test, log_loss_test, matt_coef_test]}
...
results_df.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S0\\S0_XGB_hypo.csv")

xgb_y_pred_po = mod_best.predict_proba(X_test)
xgb_mod_po = mod_best
xgb_y_po_test = y_test
xgb_X_po_test = X_test

print(colored("\n...........SHIP0 HYPOTHYROIDISM CLASSIFICATION XGBOOST MODELLING FINISHED............\n\n", "green"))
