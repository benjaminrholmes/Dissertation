...
print(colored("\n...........SHIP0 HYPOTHYROIDISM CLASSIFICATION SVM MODELLING STARTED............\n\n", "green"))
...
matt_coef_train = matthews_corrcoef(y_train, xgb_train_preds)
...
results_df.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S0\\S0_SVM_hypo.csv")
...
print(colored("\n...........SHIP0 HYPOTHYROIDISM CLASSIFICATION SVM MODELLING FINISHED............\n\n", "green"))