...
from pre_processing.pre_processing import hyper_SHIP2_scaled
from termcolor import colored

print(colored("\n...........SHIP2 HYPERTHYROIDISM CLASSIFICATION XGBOOST MODELLING STARTED............\n\n", "green"))

X, y = hyper_SHIP2_scaled.drop(['FT4', 'BIN_HYPO', 'BIN_HYPER'], axis=1), hyper_SHIP2_scaled[['BIN_HYPER']]
...
results_df.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S2\\S2_XGB_hyper.csv")
...
print(colored("\n...........SHIP2 HYPERTHYROIDISM CLASSIFICATION XGBOOST MODELLING FINISHED............\n\n", "green"))
