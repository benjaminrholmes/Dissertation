...
print(colored("\n...........SHIP2 HYPERTHYROIDISM CLASSIFICATION SVM MODELLING STARTED............\n\n", "green"))

X, y = hypo_SHIP2_scaled.drop(['FT4', 'BIN_HYPO', 'BIN_HYPER'], axis=1), hypo_SHIP2_scaled[['BIN_HYPER']]
...
results_df.to_csv("D:\\Files\\Work\\Pycharm Projects\\Dissertation\\analysis\\classification\\result_data\\S2\\S2_SVM_hyper.csv")
...
print(colored("\n...........SHIP2 HYPERTHYROIDISM CLASSIFICATION SVM MODELLING FINISHED............\n\n", "green"))
